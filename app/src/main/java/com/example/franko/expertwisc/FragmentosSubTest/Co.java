 ...
 * {@link Co.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link Co#newInstance} factory method to
...
public class Co extends Fragment {
     ...
     * @return A new instance of fragment Co.
     */
    // TODO: Rename and change types and number of parameters
    public static Co newInstance(String param1, String param2) {
        Co fragment = new Co();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        res_co = view.findViewById(R.id.res_co);
        guardar = view.findViewById(R.id.guardar_co);
        imageView = view.findViewById(R.id.show_co);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                TextView txtclose;
                Button btnFollow;
                myDialog.setContentView(R.layout.pop_up_co);
        ...
        res_co.setText(Utilidades.R_co);
        res_co.addTextChangedListener(new TextWatcher() {
            @Override
...
//                    Toast.makeText(getContext(),"El valor no debe de ser mayor a 28",Toast.LENGTH_SHORT).show();
                    Snackbar.make(view, "El valor no debe de ser mayor a 28", Snackbar.LENGTH_LONG)
                            .setAction("Action", null).setActionTextColor(Color.RED).show();
                }
    ...
    private void enableSubmitIfReady() {
        boolean isReady = res_co.getText().toString().length() >= 1;
