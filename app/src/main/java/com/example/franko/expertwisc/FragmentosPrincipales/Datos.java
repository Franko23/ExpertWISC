...
public class Datos extends Fragment {
    ...
    View view;
    AutoCompleteTextView area, edad, motivo, antecedentes;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        area = view.findViewById(R.id.submit_area);
        edad = view.findViewById(R.id.submit_edad);
        motivo = view.findViewById(R.id.submit_motivo);
        antecedentes = view.findViewById(R.id.submit_antecedentes);

        recyclerViewBase = view.findViewById(R.id.list_base);
