...
public class AboutMe extends Fragment {
    ...
    View view;
    ImageView facebook, whatsapp, instagram;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        whatsapp.setOnClickListener(this::onClick);
    ...
    public void onClick(View v) {
        ...
        switch(v.getId()) {
            case R.id.facebook:
                ...
                break;
            case R.id.whatsapp:
                Intent whatsapp = new Intent(Intent.ACTION_VIEW, Uri.parse("https://wa.me/59179395096"));
                startActivity(whatsapp);

                break;
            case R.id.instagram:
                Intent instagram = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.instagram.com/quevedofranko/"));
