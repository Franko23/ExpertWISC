 ...
 * {@link Ar.OnFragmentInteractionListener} interface
...
public class Ar extends Fragment {
    ...
    Button guardar;
    EditText res_ar;
    RadioButton radioButtonRd, radioButtonLn;
    TextView txt_titulo;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        res_ar = view.findViewById(R.id.res_ar);
        guardar = view.findViewById(R.id.guardar_ar);
        imageView = view.findViewById(R.id.show_ar);
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                TextView txtclose;
                Button btnFollow;
                myDialog.setContentView(R.layout.pop_up_ar);
        ...
        res_ar.setText(Utilidades.R_ar);
        res_ar.addTextChangedListener(new TextWatcher() {
            @Override
...
//                    Toast.makeText(getContext(),Utilidades.R_ar+" GUARDADO",Toast.LENGTH_SHORT).show();
                    Snackbar.make(view, Utilidades.R_ar +" puntos guardado", Snackbar.LENGTH_LONG)
...
//                    Toast.makeText(getContext(),"El valor no debe de ser mayor a 34",Toast.LENGTH_SHORT).show();
                    Snackbar.make(view, "El valor no debe de ser mayor a 34", Snackbar.LENGTH_LONG)
                            .setAction("Action", null).setActionTextColor(Color.RED).show();
                }
    ...
    private void Dialogreemplazo() {
        ...
        View alertLayout = inflater.inflate(R.layout.dialog_mo, null);

        radioButtonRd = alertLayout.findViewById(R.id.radioButtonRd);
        radioButtonLn = alertLayout.findViewById(R.id.radioButtonLn);

        radioButtonRd.setText("3. Retención de Dígitos - "+Utilidades.R_rd);
        radioButtonLn.setText("7. Letras y Números - "+Utilidades.R_ln);

        txt_titulo = alertLayout.findViewById(R.id.txt_titulo);

        txt_titulo.setText("Selecciona la prueba a que será reemplazada por la nueva puntuacion de "+Utilidades.R_ar);
...
//
    ...
    private void enableSubmitIfReady() {
        boolean isReady = res_ar.getText().toString().length() >= 1;
